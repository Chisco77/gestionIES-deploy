...
--
-- Name: sustituciones; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.sustituciones (
    id bigint NOT NULL,
    uid_titular character varying(50) NOT NULL,
    uid_sustituto character varying(50) NOT NULL,
    fecha_inicio date DEFAULT CURRENT_DATE NOT NULL,
    fecha_fin date,
    curso_academico character varying(20),
    observaciones text,
    creada_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT chk_fechas_sustitucion CHECK (((fecha_fin IS NULL) OR (fecha_fin >= fecha_inicio))),
    CONSTRAINT chk_sustituto_distinto CHECK (((uid_titular)::text <> (uid_sustituto)::text))
);


--
-- Name: sustituciones_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.sustituciones ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.sustituciones_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sustituciones sustituciones_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sustituciones
    ADD CONSTRAINT sustituciones_pkey PRIMARY KEY (id);
...
('LENGUA (REFUERZO)'),
('ÁMBITO CIENTÍFICO'),
('ACTIVIDADES RIEGO ABONADO TRATAMIENTO CULTIVOS'),
('APOYO DOMICILIARIO'),
('ATENCIÓN EDUCATIVA'),
('ACTIVIDADES FÍSICAS'),
('ATENCIÓN HIGIÉNICA'),
...
('APOYO COMUNICACIÓN'),
('ÁMBITO PRÁCTICO'),
('AUTONOMÍA PERSONAL SALUD INFANTIL'),
...
('CIENCIAS GENERALES'),
('CULTURA CLÁSICA'),
('CARACTERÍSTICAS Y NECESIDADES PSD'),
...
('INTERVENCIÓN FAMILIAS MENORES SITUACIÓN RIESGO'),
...
('MATEMÁTICAS I'),
('MATEMÁTICAS A'),
('MATEMÁTICAS A BILINGÜE'),
('MATEMÁTICAS B BILINGÜE'),
('MATERIALES FLORISTERIA'),
('MÚSICA EN EXTREMDURA'),
('MÚSICA'),
('MÚSICA BILINGÜE'),
('OPERACIONES AUXILIARES ELABORACIÓN COMPOSICIONES FLORES PLANTAS'),
('ORGANIZACIÓN ATENCIÓN PSD'),
('OPERACIONES BÁSICAS INSTALACIONES JARDINES PARQUES...'),
('OPERACIONES BÁSICAS MANTENIMIENTO JARDINES, PAQUES....'),
('OPERACIONES AUXILIARES PREPARACIÓN TERRENO PLANTACIÓN...'),
('OPERACIONES BÁSICAS PRODUCCIÓN MANTENIMIENTO PLANTAS VIVEROS'),
('OPTATIVA'),
('PRIMEROS AUXILIOS'),
...
('REUNIÓN DE TUTORES 1º'),
('REUNIÓN DE TUTORES 2º'),
('REUNIÓN DE TUTORES 3º'),
('REUNIÓN DE TUTORES 4º'),
('REUNIÓN DE TUTORES CFGB'),
